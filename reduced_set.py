...
class ReducedSetMethod:
    ...
    def fit(self, input_data, f, args):
        ...
        self.kernel_matrix = compute_kernel(subset_data, f, args)
        entropy = self._renyi_entropy(self.kernel_matrix)
        ...
        for _ in range(self.max_iter):
            ...
            new_kernel_matrix = compute_kernel(input_data[list(self.idx_working_set), :], f, args)
            new_entropy = self._renyi_entropy(new_kernel_matrix)
            ...
            # accept
            self.kernel_matrix = new_kernel_matrix
            entropy = new_entropy
            self.entropy_trace.append(entropy)